...
/**
 * REST-style endpoint for translating text via the Gemini API.
 * Expects JSON body: {"text": "...", "language": "..."}
 * Returns JSON:      {"result": "..."}
 */
...
public class TranslateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String language = body.has("language") ? body.get("language").getAsString() : "English";

            String result = geminiClient.translate(text, language);
            ...
            LOGGER.log(Level.SEVERE, "Error in translate endpoint", e);
            response.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);

            JsonObject errorResponse = new JsonObject();
            errorResponse.addProperty("result", "Error: Translation failed. Please try again.");
