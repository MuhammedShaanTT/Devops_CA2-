...
<head>
    ...
    <title>${fn:escapeXml(note.title)} — SmartNotes AI</title>
    ...
    <main class="content">
        ...
        <div class="toolbar">
            <div class="toolbar-left">
                ...
                <!-- AI Action Buttons -->
                <button type="button" class="btn btn-ai" onclick="summarizeNote(document.getElementById('note-content-field').textContent)" title="Summarize">
                ...
                <button type="button" class="btn btn-ai" onclick="generateStudyNotes(document.getElementById('note-content-field').textContent)" title="Generate Study Notes">
            ...
            <div class="toolbar-right">
                ...
                <a href="${pageContext.request.contextPath}/update?id=${note.id}" class="btn btn-primary">
        ...
        <div class="note-view">
            ...
            <div class="note-view-meta">
                ...
                <span data-date="${note.updatedAt}" class="note-date">${note.updatedAt}</span>
                <c:if test="${not empty note.createdAt}">
                    <span>&middot;</span>
                    <span>Created <span data-date="${note.createdAt}" class="note-date">${note.createdAt}</span></span>
                </c:if>
            </div>

            <div class="note-view-content" id="note-content-field">${fn:escapeXml(note.content)}</div>
        </div>
    </main>
</div>
